...
class myDB extends mysqli
{
    ...
    /**
     * Method checks first if there's an active connection. If there is, performs query and stores the results as individual objects, for each row, in an array of objects while also recording the names of the properties of the [class of] objects. If $objects is already set from a a previous query, it is first unset.
